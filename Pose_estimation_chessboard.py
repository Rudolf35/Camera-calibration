...
K = np.array([[1126.59018, 0, 636.536514],
              [0, 1126.18158, 347.526654],
              [0, 0, 1]])
dist_coeff = np.array([0.0462454012, -1.80653529, -0.000179384647e-04, 0.0001149909868437517, -0.000882634307])
board_pattern = (7, 4)
...
box_lower = board_cellsize * np.array([[1,0,0], [2,0,0], [2,1,0], [3,0,0], [4,0,0],[4,3,0],[3,3,0],[3,2,0],[2,3,0],[1,3,0]])
box_upper = board_cellsize * np.array([[1,0,-1], [2,0,-1], [2,1,-1], [3,0,-1], [4,0,-1],[4,3,-1],[3,3,-1],[3,2,-1],[2,3,-1],[1,3,-1]])
